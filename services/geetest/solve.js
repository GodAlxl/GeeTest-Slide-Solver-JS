...
async function build(img){
    ...
    var f = ['157', '145', '265', '277', '181', '169', '241', '253', '109', '97', '289', '301', '85', '73', '25', '37', '13', '1', '121', '133', '61', '49', '217', '229', '205', '193']
    var s = ['145', '157', '277', '265', '169', '181', '253', '241', '97', '109', '301', '289', '73', '85', '37', '25', '1', '13', '133', '121', '49', '61', '229', '217', '193', '205']

    for (i = 0; i < 26; i++){
		
		var img2 = img.clone();
		
        img2.crop(parseInt(f[i]), 80, 10, 80)
    ...
    for (i = 0; i < 26; i++){
        ...
        img2.crop(parseInt(s[i]), 0, 10, 80)
